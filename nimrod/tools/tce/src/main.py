...
import nimrod.tools.tce.src.Analyses as Analyses


def exec(rt_jar, soot, mujava_res, exp_dir, action, methods='', mutants=''):
    Analyses.rt_jar_location = rt_jar
    Analyses.soot_executable = soot
    mujava_result_dir = mujava_res
...
##############################################################################
    ...
    if 'Ted' in action:
        ...
        print("########################## ")
        print(muts_per_class)
        print(equiv_muts_per_class)
        print("########################## ")
